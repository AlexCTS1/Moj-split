  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        goal: "Prsa",
        how: [
          "Sjedni na spravu, rucke u visini prsa.",
          "Guraj prema naprijed dok ruke ne budu skoro ispruzene."
        ],
        tips: []
      },
      {
        name: "Lateral raise",
        sets: 4, reps: "12–20", rir: "0–1", rest: "60 s",
        goal: "Bocno rame",
        how: [
      ...
      },
      {
        ...
        goal: "Biceps",
        how: [
          "Naslon nadlaktica na kosu podlogu.",
          "Radi pregib za biceps kontrolirano, bez zamaha."
        ],
        tips: ["Odlicna vjezba jer ne mozes puno varati tijelom"]
      },
      {
        name: "Overhead cable triceps extension",
        sets: 3, reps: "10–15", rir: "0–1", rest: "60 s",
        goal: "Triceps (duga glava)",
        how: [
          "Okreni se ledjima od sajle, konop drzi iza glave.",
          "Ispruzi ruke prema naprijed/gore.",
          "Kontrolirano vrati."
        ],
        tips: []
      },
